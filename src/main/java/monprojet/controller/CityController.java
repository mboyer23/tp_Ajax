...
public class CityController {
	 ...
	 * Spring fait une requête SQL pour récupérer la ville par son id.
	 * @return le nom de la vue à afficher
	 */	
	 ...
	 * @param laVille la ville à enregistrer, initialisée par Spring à partir des valeurs soumises dans le formulaire
	 * Spring fera automatiquement une requête SQL SELECT pour récupérer le pays à partir de son id.	 
	 * Spring fera une requête SQL INSERT ou UPDATE pour enregistrer la ville dans la base
	 * @return une redirection vers la page d'affichage des villes
	 */
